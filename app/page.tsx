          ...
          <div className="container">
            <div className="header-content">
              ...
              <nav>
                ...
                <a className="btn-primary" href="/apply">Get Started</a>
              </nav>
            </div>
          </div>
        </header>
        ...
        <main>
            ...
            <div className="container">
              <div className="hero-content">
                ...
                <div className="hero-actions fade-in fade-in-delay-2">
                  <a href="/apply" className="btn-primary" style={{ fontSize: '18px', padding: '16px 40px' }}>
                    Start Distributing
                  </a>
          ...
          <section className="cta-section" id="start">
            <div className="container">
              ...
              <a href="/apply" className="btn-primary fade-in fade-in-delay-2" style={{ fontSize: '18px', padding: '18px 50px' }}>Get Started Now</a>
            </div>
          </section>
